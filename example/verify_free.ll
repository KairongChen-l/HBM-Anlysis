...
@.str = private unnamed_addr constant [38 x i8] c"Loop %zu iterations (32 KiB each)\E2\80\A6\0A\00", align 1
...
14:                                               ; preds = %12, %34
  ...
  %16 = tail call ptr @hbm_malloc(i64 noundef 32768) #5
